...
var num = [2, 5, 6, 7, 3];
console.log("intentional index error as I am trying to access 5 index and my array has only(0,1,2,3,4) indexes ");
console.log(num[5]);
console.log("now I am fixing this index error by pushing element at 5th index and running the same command again");
num.push(8);
console.log(num[5]);
console.log("_____________________________________________________________________________________________________________________");
